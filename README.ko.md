...
| [**engineering-guardrails**](skills/engineering-guardrails/) ([한국어](skills/engineering-guardrails/README.ko.md)) | 나중에 대규모 리팩토링을 하게 만드는 구조적 부채를 애초에 안 쌓는 규칙. 4,300줄 컴포넌트를 뜯어내며 나온 것들 — **이음매 비용 측정기**, 조용한 실패 목록, 파생 vs 저장, 상시 검사 5종과 기준선 쓰는 법 |
